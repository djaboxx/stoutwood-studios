...
# When scripts are bundled inside the VS Code extension, the extension sets the
# subprocess cwd to the user's workspace root before spawning Python. Using
# Path.cwd() here lets all database/ paths resolve correctly regardless of where
# the script file physically lives.
REPO_ROOT = Path.cwd()
